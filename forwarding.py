...
def upnp_set_description(description):
    return c_double(forwarding.upnp_set_description(description))
def upnp_discover(delay):
    return c_double(forwarding.upnp_discover(delay))
def upnp_forward_port(iport, eport, proto, leaseDuration):
    return c_double(forwarding.upnp_forward_port(iport, eport, proto, leaseDuration))
def upnp_release_port(eport, proto):
    return c_double(forwarding.upnp_release_port(eport, proto))
